...
class FlagNotImplementException extends Exception
{
    protected string $instruction = "check `/Config/flags.php` file to implement languages flags.";

    public function __construct($language, $code = 0, Throwable $previous = null) {
        $message = "'$language' Flag is not implements.";
